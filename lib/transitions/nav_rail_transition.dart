...
class _NavRailTransitionState extends State<NavRailTransition> {
  //The animations are only rebuilt by this method when the text direction changes
  // because this widget only depends on Directionality
  ...
  late final Animation<double> widgetAnimation = Tween<double>(begin: 0, end: 1)
